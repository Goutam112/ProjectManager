...
class ProjectItem extends Component {
    ...
    renderContent() {
        ...
        this.element.querySelector('h3').textContent = `${this.persons} contributing`;
...
class ProjectInput extends Component {
    ...
    gatherUserInput() {
        ...
        const titleChecker = { value: enteredTitle, required: true };
        const descriptionChecker = { value: enteredDescription, required: true, minLength: 5 };
        const peopleChecker = { value: enteredPeople, required: true, min: 1, max: 5 };
        if (validate(titleChecker) && validate(descriptionChecker) && validate(peopleChecker)) {
